...
from self_filter_model import (
    LlavaConfig_SelfFilter,
    LlavaLlamaForCausalLM_SelfFilter_CLIP,
    LlavaLlamaForCausalLM_SelfFilter_Scores,
)
from self_filter_trainer import LLaVATrainer_SelfFilter
...
class ModelArguments:
    ...
    feature_extractor_setting: Optional[str] = field(default=None)
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if "mpt" in model_args.model_name_or_path:
            ...
            print(
                "model_args.feature_extractor_setting",
                model_args.feature_extractor_setting,
            )
            if model_args.feature_extractor_setting == "clip":
            ...
            elif model_args.feature_extractor_setting == "scores":
                ...
                print(
                    "Unknown feature extractor setting:",
                    model_args.feature_extractor_setting,
                )
                raise NotImplementedError
    else:
    ...
    trainer = LLaVATrainer_SelfFilter(
        model=model,
        tokenizer=tokenizer,
        args=training_args,
